...
class LaneLines:
    ...
    def __init__(self, res_dir):
        ...
        self.left_curve_img = mpimg.imread(self.res_dir+'left_turn.png')
        self.right_curve_img = mpimg.imread(self.res_dir+'right_turn.png')
        self.keep_straight_img = mpimg.imread(self.res_dir+'straight.png')
    ...
    def find_lane_pixels(self, img):
        ...
        # rect_img = np.dstack((img, img, img))
        ...
        for _ in range(self.nwindows):
            ...
            # cv2.circle(rect_img, (leftx_current, y_current), 3, (0, 0, 255), 3)
            # cv2.circle(rect_img, (rightx_current, y_current),
            #            3, (0, 255, 0), 3)
    ...
    def plot(self, out_img):
        ...
        lR, rR, pos = self.measure_curvature(out_img)
        ...
        return out_img, min(lR, rR), pos

    def measure_curvature(self, img):
        # 假设垂直方向每720个像素30米，水平方向每700个像素3.7米
        ym = 30/720
        xm = 3.7/700
        ...
        pos = (img.shape[1]//2 - (xl+xr)//2)*xm

        # 另一种方法
        # bottom_y = img.shape[0] - 1
        # bottom_x_left = left_fit[0]*(bottom_y**2) + \
        #     left_fit[1]*bottom_y + left_fit[2]
        # bottom_x_right = right_fit[0]*(bottom_y**2) + \
        #     right_fit[1]*bottom_y + right_fit[2]
